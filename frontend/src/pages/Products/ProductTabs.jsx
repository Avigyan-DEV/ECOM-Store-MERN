        ...
        {activeTab === 1 && (
          <div className="mt-4">
            {userInfo ? (
              <form onSubmit={submitHandler}>
                <div className="my-2">
                  ...
                  <select
                    ...
                    className="p-2 border rounded-lg xl:w-160 text-white"
                  >
              ...
              <p>
                Please <Link to="/login" className="underline hover:text-pink-600">sign in</Link> to write a review
              </p>
            )}
          </div>
        )}
          ...
          <>
            ...
            <div>
              {product.reviews.map((review) => (
                <div
                  key={review._id}
                  className="bg-[#1A1A1A] p-4 rounded-lg xl:ml-8 sm:ml-0 xl:w-200 sm:w-[24rem] mb-5"
                >
