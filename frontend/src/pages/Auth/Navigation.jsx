  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center space-y-4">
        <Link
          to="/"
          className="flex items-center transition-transform transform hover:translate-x-2 hover:text-pink-600"
        >
        ...
        <Link to="/cart" className="flex relative hover:text-pink-600">
        ...
        <Link to="/favorite" className="flex relative hover:text-pink-600">
      ...
      <div className="relative">
        ...
        >
          ...
          {userInfo && (
            <svg
              ...
              } hover:bg-pink-600 rounded-full`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="white"
            >
        ...
        {dropdownOpen && userInfo && (
          <ul
            className={`absolute right-0 mt-3 mr-7 space-y-2 bg-white/10 text-white ${
          ...
          >
            ...
            <li>
              <Link to="/profile" className="block px-4 py-2 hover:bg-pink-700">
                Profile
              </Link>
            </li>
            <li>
              <button
                ...
                className="block w-full px-4 py-2 text-left hover:bg-pink-700"
              >
                Logout
              </button>
            </li>
